    ...
    <form @submit.prevent="updatePost(post)">
        <!-- Title -->
         <div>
            ...
            <input v-model="post.title" id="post-title" name="title" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="mt-4">
            ...
            <textarea v-model="post.content" id="post-content" name="content" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
            <div class="text-red-600 mt-1">
        ...
        <div class="mt-4">
            ...
            <select v-model="post.category_id" id="post-category" name="category_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
...
<!-- Thumbnail -->
        ...
        <!-- Buttons -->
        <div class="mt-4">
            <button :disabled="isLoading" class="rounded-md bg-indigo-600 px-3 py-2 text-sm uppercase text-white disabled:opacity-75 disabled:cursor-not-allowed">
